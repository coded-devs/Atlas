    ...
    "connections": {
        ...
        "hubspot_crm_002": {
            ...
            "status": {
                ...
                "is_historical_sync": False,
                "tasks": [],
                "warnings": ["Slow sync: last run took 47 minutes"],
        ...
        "salesforce_crm_003": {
            ...
            "status": {
                ...
                "is_historical_sync": False,
                "tasks": [],
                "warnings": ["Schema drift detected: 2 columns missing in destination"],
                "succeeded_at": (_NOW - timedelta(hours=8)).isoformat() + "Z",
                "failed_at": (_NOW - timedelta(hours=2)).isoformat() + "Z",
            },
            "schemas": {
                "salesforce": {
